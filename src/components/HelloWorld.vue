<template>
  <div class=" container mx-auto py-10">
    <div class="border m-6 rounded-lg  bg-gray-900 mx-auto max-w-sm shadow-lg rounded-lg overflow-hidden">
      <div class="sm:flex sm:items-center px-6 py-4">
          ...
          <div class="text-center sm:text-left sm:flex-grow">
            <div class="mb-4">
              <p class="text-xl leading-tight quip-light-yellow">Jane Doe</p>
              <p class="text-sm leading-tight text-white">Software Developer at SpongeBob LLC.</p>
            </div>
